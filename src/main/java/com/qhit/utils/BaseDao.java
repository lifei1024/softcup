...
public class BaseDao {
    ...
    //需要生成mapper文件的sql语句
    private static String sql = "SELECT bf.flowid,bf.flowname,bd1.devname AS dljname,bd2.devname AS zcjname,bd3.devname AS pdjname,bc.compname\n" +
    ...
    //主表
    private static String mainTable = "base_flow";
...
//                    插入association配置
    ...
    public   static  Connection getConn(){
        ...
        String url = "jdbc:mysql://localhost:3306/ems?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC&zeroDateTimeBehavior=convertToNull";
