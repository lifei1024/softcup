...
public interface IEnergyConsumeDao {
    ...
    List flowConsume(String month,String year,String compid);
    List devTypeConsume(String month,String year,String compid);
    List devConsume(String month,String year,String compid);
    List electricConsume(String month,String year,String compid);
    List waterConsume(String month,String year,String compid);
    List oilConsume(String month,String year,String compid);
}