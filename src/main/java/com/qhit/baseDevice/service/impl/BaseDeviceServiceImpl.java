...
public class BaseDeviceServiceImpl  implements IBaseDeviceService {
    ...
    @Override
    public List<BaseDevice> findDljId(int i,int a) {
        List list = dao.findByTypeidCompId(i,a);
        return list;
    }

    @Override
    public List<BaseDevice> findzcjId(int i,int a) {
        List list = dao.findByTypeidCompId(i,a);
        return list;
    }

    @Override
    public List<BaseDevice> findpdjId(int i,int a) {
        List list = dao.findByTypeidCompId(i,a);
        return list;
    }
